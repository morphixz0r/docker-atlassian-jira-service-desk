## Based off https://github.com/cptactionhank/docker-atlassian-jira-service-desk
...
RUN set -x \
    ...
    && curl -Ls                "${JIRASD_DOWNLOAD_URL}" | tar -xz --directory "${JIRA_INSTALL}" --strip-components=1 --no-same-owner \
